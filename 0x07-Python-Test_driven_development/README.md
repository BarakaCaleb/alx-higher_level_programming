...
During this project, I've started practising test-driven development using 'docstring' and 'unit test' in python programming language.

## Tests :page_with_curl:

* [tests](./tests): This folder od the test files contains ones as provided by ALX and also others independently-developed:
* [0-add_integer.txt](./tests/0-add_integer.txt)
* [2-matrix_divided.txt](./tests/2-matrix_divided.txt)
* [3-say_my_name.txt](./tests/3-say_my_name.txt)
* [4-print_square.txt](./tests/4-print_square.txt)
* [5-text_identation.txt](./tests/5-text-identation.txt)
* [6-max_integer_test.py](./tests/6-max_integer_test.py)
* [100-matrix_mul.txt](./tests/100-matrix_mul.txt)
* [101-lazy_matrix_mul.txt](./tests/101-lazy_matrix_mul.txt)


## Functions Prototypes :heavy_check_mark

The following are the prototypes used in this project:
