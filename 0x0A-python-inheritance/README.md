...
Defining classes with multiple base classes, and overiding inherited methods and attributes.


## Tests

* [tests](./tests): Folder contains test files.
They include independent developed as well as provided by ALX
